    ...
    <div class="container mt-3">
        ...
        // check if password is the same 
            ...
            if (count($errors)>0){
                ...
                $sql = "INSERT INTO users (Last_Name, First_Name, email, password, lot_block, street, phase_subdivision, barangay, city, province, Country, phone) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        <form action="index.php" method="post">
            <div class="row jumbotron box8">
                ...
                <div class="col-sm-6 form-group">
                    ...
                    <input type="text" class="form-control" name="lot_block" placeholder="Lot/Block/House Number" required>
                </div> 
                ...
                <div class="col-sm-6 form-group">
                    ...
                    <input type="text" class="form-control" name="phase_subdivision" placeholder="Phase/Subdivision" required>
                </div>
